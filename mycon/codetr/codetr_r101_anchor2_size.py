...
train_pipeline = [
    ...
    dict(
        ...
        policies=[[{
            'type':
            'Resize',
            'img_scale': [(400, 400), (500,500), (600, 600), (700,700), 
                                  (800, 800), (1000, 1000), (1200, 1200), (1400, 1400), 
                                  (1600, 1600), (1800,1600), (2000,1600), (2200,1600)],
            'multiscale_mode':
            'value',
            'keep_ratio':
            True
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix='/mnt/data/images/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=False),
            dict(type='RandomFlip', flip_ratio=0.5),
            dict(
                ...
                policies=[[{
                    ...
                    'img_scale': [(400, 400), (500,500), (600, 600), (700,700),
                                  (800, 800), (1000, 1000), (1200, 1200), (1400, 1400),
                                  (1200, 1600), (1800,1200), (2000,1200)],
                    'multiscale_mode':'value',
                    'keep_ratio':True
                }],
                          [{
                              'type': 'Resize',
                              'img_scale': [(400, 4200), (600, 4200),
                                            (800, 4200), (1000,4200)],
                              'multiscale_mode': 'value',
                              'keep_ratio': True
                          }, {
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/mnt/data/annotations/val.json',
        img_prefix='/mnt/data/images/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            octave_base_scale=4,
            scales_per_octave=3,
            ratios=[0.2, 0.3, 0.5, 1.0, 2.0, 3.0, 5.0],
